...
${OBJECTDIR}/_ext/1436307855/bsp.o: ../src/system_config/sdcard_pic32mz_ef_sk_meb2/bsp/bsp.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1436307855/bsp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/system_config/sdcard_pic32mz_ef_sk_meb2" -I"../src/sdcard_pic32mz_ef_sk_meb2" -I"../../../../../framework" -I"../src/system_config/sdcard_pic32mz_ef_sk_meb2/framework" -I"../src/system_config/sdcard_pic32mz_ef_sk_meb2/bsp" -MMD -MF "${OBJECTDIR}/_ext/1436307855/bsp.o.d" -o ${OBJECTDIR}/_ext/1436307855/bsp.o ../src/system_config/sdcard_pic32mz_ef_sk_meb2/bsp/bsp.c    -DXPRJ_sdcard_pic32mz_ef_sk_meb2=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/_ext/1173264622/sys_memory_smc_static.o: ../src/system_config/sdcard_pic32mz_ef_sk_meb2/framework/system/memory/smc_pic32c/src/sys_memory_smc_static.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1173264622" 
	@${RM} ${OBJECTDIR}/_ext/1173264622/sys_memory_smc_static.o.d 
	@${RM} ${OBJECTDIR}/_ext/1173264622/sys_memory_smc_static.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1173264622/sys_memory_smc_static.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/system_config/sdcard_pic32mz_ef_sk_meb2" -I"../src/sdcard_pic32mz_ef_sk_meb2" -I"../../../../../framework" -I"../src/system_config/sdcard_pic32mz_ef_sk_meb2/framework" -I"../src/system_config/sdcard_pic32mz_ef_sk_meb2/bsp" -MMD -MF "${OBJECTDIR}/_ext/1173264622/sys_memory_smc_static.o.d" -o ${OBJECTDIR}/_ext/1173264622/sys_memory_smc_static.o ../src/system_config/sdcard_pic32mz_ef_sk_meb2/framework/system/memory/smc_pic32c/src/sys_memory_smc_static.c    -DXPRJ_sdcard_pic32mz_ef_sk_meb2=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
